...
title: "Developer's Guide to the tlverse"
subtitle: ""
author: "Jeremy Coyle, Nima Hejazi, Ivana Malenica, Rachael
  Phillips"
...
url: 'https\://tlverse.org/tlverse-developers/'
github-repo: tlverse/tlverse-developers
twitter-handle: tlverse
graphics: yes
description: "A Developer's Guide to understanding and contributing to the [`tlverse` software
...
repository](https://github.com/tlverse/tlverse-developers).
...
developers interested in using the tlverse to implement novel estimators
and other methodological improvements related to Targeted Learning. The
goal of tlverse is to make it easier for methods researchers to quickly implement 
and test (through Monte Carlo simulation) their innovations. Having done so,
we hope that they will make their tlverse-based implementations available
to people interested in applying their methods going forward. We believe that
this is the best way to create a maintainable and continually improving
set of implementations for Targeted Learning.

The (evolving) set of materials includes:

* Motivation
* Introduction to the [`tlverse` software
    ecosystem](https://tlverse.org)
* Computation graphs and Parallelization with the [`delayed`](https://github.com/tlverse/delayed)
    package
...
* Targeted Learning with the
    [`tmle3`](https://github.com/tlverse/tmle3) package
* Monte Carlo simulation with the
    [`tmle3sim`](https://github.com/tlverse/tmle3sim) package
* Highly Adaptive Lasso with the
    [`hal9001`](https://github.com/tlverse/hal9001) package
* How to contribute
* Code quality (Style, Documentation, Testing)


We encourage you to reference the corresponding chapters of the [`tlverse` handbook](tlverse.org/tlverse-handbook) for a more applied perspective on how end users will use these tools for their own research.
...
source is available on [GitHub](https://github.com/tlverse/tlverse-developers).
...
|:------------|:----------|:--------------------------------------|
|bookdown     |0.24.1     |Github (rstudio/bookdown\@7ce6dc6)     |
|bslib        |0.3.0.9000 |Github (rstudio/bslib\@d77f5ce)        |
|dagitty      |0.3-1      |CRAN (R 4.1.1)                         |
|data.table   |1.14.0     |CRAN (R 4.1.1)                         |
...
|tibble       |3.1.4      |CRAN (R 4.1.1)                         |
|tidyr        |1.1.3      |CRAN (R 4.1.1)                         |
|tmle3        |0.2.0      |Github (tlverse/tmle3\@425e21c)        |
|tmle3mediate |0.0.3      |Github (tlverse/tmle3mediate\@70d1151) |
|tmle3mopttx  |0.1.0      |Github (tlverse/tmle3mopttx\@0e63aa2)  |
